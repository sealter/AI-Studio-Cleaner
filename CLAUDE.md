...
**AI Studio History Cleaner** (v1.2.33) is a lightweight, browser-based tool that parses Google AI Studio JSON export files and converts them to clean, readable Markdown format. It supports optional inclusion of model "thinking/reasoning" blocks.
